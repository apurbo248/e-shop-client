    ...
    <div>
      ...
      >
        <div class=" relative  pointer-events-none ">
          <div class=" md:pt-8  border-none  relative flex flex-col w-full overflow-x- height pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
            <div class=" flex flex-shrink-0 items-center  justify-between  border-b border-gray-200 rounded-t-md">
              <h5 class="font-semibold text-lg  ">Update user information</h5>
            </div>
