          ...
          <div className="mt-1 flex flex-col xl:flex-row jusitfy-center items-stretch  w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
            <div className="flex flex-col justify-start items-start w-full space-y-4 my-4 md:space-y- xl:space-y-">
              <div className="flex flex-col justify-start items-start bg-white shadow-md  px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                {cartItems &&
                  cartItems.map((item) => (
                    <div className=" flex  flex-row  justify-start items-start md:items-center  xl:space-x-8 w-full ">
                      ...
                      <div className=" flex-row  flex  items-start w-full  pb-4 space-y-0 md:space-y-0">
                        <div className="w-full flex flex-row justify-start items-start space-y-">
              ...
              <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                <div className="flex flex-col px-4 py-2 md:p-6 xl:p-8 w-full bg-white shadow-md space-y-6   ">
                  ...
                  <div className="flex  flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0 ">
                    ...
                    <div className="flex justify-between xl:h-full  items-stretch w-full flex-col  md:mt-0">
                      <div className="flex justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row items-start ">
                        <div className="flex justify-start  py-2 items-start flex-col space-y-4 xl:mt-8">
